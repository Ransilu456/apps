...
export default function HomeScreen() {
    ...
    return (
        <LinearGradient colors={['#F7F4EF', '#ffeac6ff']} style={{ flex: 1 }}>
            ...
            {/* --- Logo --- */}
            <ThemedView
                style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'transparent', marginTop: 50 }}>
                <Image
            ...
            {/* --- Button --- */}
            <ThemedView
                style={{ flex: 1, justifyContent: 'flex-end', alignItems: 'center', marginBottom: 0, backgroundColor: 'transparent', }}>
                <CustomButton title="ආරම්භ කරන්න"
                    icon={<Ionicons name="apps-outline" size={20} color="#FFF"
                        style={{ marginRight: 8 }} />}
                    style={{ backgroundColor: '#F4B400', with: '100%', paddingHorizontal: 80, paddingVertical: 14, borderRadius: 10, marginBottom: 40 }}
                    pressedStyle={{ backgroundColor: '#F48400' }}
